...
for year in YEARS:
    for s in SPECIES:
        ...
        fname = '{}-em-SOLID-BIOFUEL-anthro_input4MIPs_emissions_CMIP_CEDS-2020-03-10-supplemental-data_gn_{}.nc'.format(s, year)
        if not os.path.isfile(fname):
            fname = '{}-em-SOLID-BIOFUEL-anthro_input4MIPs_emissions_CMIP_CEDS-2020-03-09-supplemental-data_gn_{}.nc'.format(s, year)
            if not os.path.isfile(fname):
