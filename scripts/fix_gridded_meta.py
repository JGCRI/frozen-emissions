...
for s in species:
    ...
    fname = '{}-em-anthro_input4MIPs_emissions_CMIP_CEDS-2020-02-26_gn_196001-200912.nc'.format(s)
    if not os.path.isfile(fname):
        fname = '{}-em-anthro_input4MIPs_emissions_CMIP_CEDS-2020-02-27_gn_196001-200912.nc'.format(s)
    # -------------
